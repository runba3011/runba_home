class Movie < ActiveHash::Base
  ...
  self.data = [
    {id: 1 , reccomend: true , title: "【きりたんの初登場】クッキーとは何か？" , link: "8lPLWWVXNa0" , image: nil , explain: "ひじょうにながいせつめいをかこうではないか" , small_explain: ""} , 
  ...
  def self.search(search)
    if search != ""
      return_movie = Movie.like(title: "%#{search}%")
      return_movie.sort_by{|movie| movie.id}.reverse
    else
      return_movie = nil
    end
  end
